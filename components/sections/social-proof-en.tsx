export function SocialProof() {
  const stats = [
    ...
    { value: '5PB+', label: 'Data Stored' },
  ];

  const testimonials = [
    {
      quote: "Felicloud is exactly what I was looking for. Secure, private, and hosted in Europe. The lifetime plan is unbeatable!",
      author: "Marie Dubois",
      role: "Freelance Designer",
      avatar: "MD"
    },
    {
      quote: "We switched from Google Drive to Felicloud for GDPR compliance. The migration was seamless and support was excellent.",
      author: "Thomas Schmidt",
      role: "IT Manager",
      avatar: "TS"
    },
    {
      quote: "The best cloud storage investment I've made. One payment, lifetime access. No regrets!",
      author: "Sofia Romano",
      role: "Photographer",
      avatar: "SR"
    }
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Join our growing community of users who value privacy and security
          </p>
        </div>
        ...
        <div className="mx-auto mt-16 flex flex-wrap items-center justify-center gap-8">
          ...
          <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-6 py-3 shadow-sm">
            ...
            <span className="font-semibold text-gray-900">End-to-End Encryption</span>
          </div>
          <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-6 py-3 shadow-sm">
            ...
            <span className="font-semibold text-gray-900">100% EU Hosted</span>
          </div>
        </div>
      </div>
    </section>
