        ...
        <div className="mx-auto max-w-2xl px-6 lg:px-8">
          ...
          <div className="mt-8 rounded-lg bg-gray-50 p-4">
            <p className="text-xs text-gray-600 text-center">
              ...
              <Link href="/en/legal/terms" className="font-semibold text-primary hover:underline">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link href="/en/legal/privacy" className="font-semibold text-primary hover:underline">
                Privacy Policy
              </Link>
            </p>
          </div>
