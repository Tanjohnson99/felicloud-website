              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li>
                      <Link href="/fr/help" className="text-primary hover:text-primary/80">
                        {t('contact.info.quickLinks.helpCenter')}
                      </Link>
                    </li>
                    <li>
                      <Link href="/fr/support" className="text-primary hover:text-primary/80">
                        {t('contact.info.quickLinks.supportDocs')}
                      </Link>
                    </li>
                    <li>
                      <Link href="/fr/legal/privacy" className="text-primary hover:text-primary/80">
