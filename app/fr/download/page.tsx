...
export default function DownloadPage() {
  ...
  const webAccess = {
    name: t('download.webAccess.name'),
    icon: (
    ...
    description: t('download.webAccess.description'),
  ...
  const platforms = [
    {
      ...
      downloadLink: 'https://github.com/nextcloud-releases/desktop/releases/download/v4.0.1/Nextcloud-4.0.1-x64.msi',
    },
    {
      ...
      downloadLink: 'https://github.com/nextcloud-releases/desktop/releases/download/v4.0.1/Nextcloud-4.0.1.pkg',
    },
    {
      ...
      downloadLink: 'https://github.com/nextcloud-releases/desktop/releases/download/v4.0.1/Nextcloud-4.0.1-x86_64.AppImage',
    },
    {
      name: t('download.platforms.android.name'),
      icon: (
        <svg className="h-12 w-12" fill="currentColor" viewBox="0 0 24 24">
      ...
      downloadLink: 'https://play.google.com/store/apps/details?id=com.nextcloud.client',
    },
    {
      name: t('download.platforms.ios.name'),
      icon: (
        <svg className="h-12 w-12" fill="currentColor" viewBox="0 0 24 24">
      ...
      downloadLink: 'https://itunes.apple.com/us/app/nextcloud/id1125420102?mt=8',
    },
    {
      name: t('download.platforms.webdav.name'),
      icon: (
        <svg className="h-12 w-12" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z" />
        </svg>
      ),
      description: t('download.platforms.webdav.description'),
      tutorialLink: '/fr/support/webdav-tutorial',
    },
  ];
  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="bg-white rounded-2xl border-2 border-gray-200 p-8 md:p-12 hover:border-primary hover:shadow-lg transition-all">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              {t('download.nativeApps.title')}
            </h2>
            <p className="mt-4 text-lg text-gray-600">
              {t('download.nativeApps.subtitle')}
            </p>
            ...
            <div className="mt-8 rounded-lg bg-blue-50 border-2 border-blue-200 p-6 text-left">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">{t('download.nativeApps.infoBox.title')}</h3>
                  <p className="text-sm text-gray-700 mb-3">
                    {t('download.nativeApps.infoBox.description')}
                  </p>
                  <p className="text-sm text-gray-700 mb-4">
                    {t('download.nativeApps.infoBox.setupNote')}
                  </p>
                  <Link
                    href="/fr/help"
                  ...
                  >
                    ...
                    {t('download.nativeApps.infoBox.linkText')}
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('download.support.title')}</h3>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                {t('download.support.installationGuides')}
              </Link>
              <Link
                href="/fr/support"
                className="inline-flex items-center rounded-lg border-2 border-primary px-6 py-3 font-semibold text-primary hover:bg-primary hover:text-white transition-colors"
              >
                {t('download.support.systemRequirements')}
              </Link>
            </div>
          </div>
        </div>
