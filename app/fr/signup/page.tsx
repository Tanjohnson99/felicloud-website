        ...
        <div className="mx-auto max-w-2xl px-6 lg:px-8">
          ...
          <div className="mt-8 rounded-lg bg-gray-50 p-4">
            <p className="text-xs text-gray-600 text-center">
              ...
              <Link href="/fr/legal/terms" className="font-semibold text-primary hover:underline">
                {t('footer.termsOfService')}
              </Link>{' '}
              and{' '}
              <Link href="/fr/legal/privacy" className="font-semibold text-primary hover:underline">
